...
var cluster=require('cluster'), path=require('path'), usage=require('pidusage'),
  log=require('./util').parentLogger, workers=[], state={}, config={},
  startTime=Date.now(), gcCnt=0, appName;
